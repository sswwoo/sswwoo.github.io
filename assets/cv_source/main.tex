...
\geometry{left=1.4cm, top=1.6cm, right=1.2cm, bottom=1cm}
...
% Header
\begin{center}
    {\Huge\textbf{Seungwoo Lee}}
\end{center}
\vspace{-2mm}

\begin{center}
    \small{
    \faEnvelope\ \href{mailto:woo@mmai.io}{woo@mmai.io} | 
    \faGlobe\ \href{https:/sswwoo.github.io/}{sswwoo.github.io}
    }
\end{center}
\vspace{-6mm}
...
\begin{center}
    \small{
    \socialicon{\aiGoogleScholar} \href{https://scholar.google.com/citations?hl=en&user=wxxcAckAAAAJ}{Google Scholar} |
    \socialicon{\faLinkedin} \href{https://www.linkedin.com/in/swoolee}{LinkedIn} | 
    \socialicon{\faGithub} \href{https://github.com/sswwoo}{GitHub}
...
\vspace{1mm}
\small{
My research focuses on multimodal AI, with a particular interest in grounding physical properties in visual scenes, enabling AI systems to understand not only what objects look like, but also how they hear, feel, smell, and interact with the real world.
}
% \vspace{1mm}
...
{PhD in Electrical Engineering}{Mar 2026 - Present}
\vspace{1mm}
\resumeItemListStart
...
\resumeSubheading
{Korea Advanced Institute of Science and Technology (KAIST)}{Daejeon, South Korea}
{MS in Electrical Engineering}{Mar 2024 - Feb 2026}
\vspace{1mm}
\resumeItemListStart
\item Advisor: Joon Son Chung
\resumeItemListEnd
...
\resumeSubheading
{Korea Advanced Institute of Science and Technology (KAIST)}{Daejeon, South Korea}
{BS in Electrical Engineering}{Mar 2017 - Feb 2024}
\vspace{1mm}
...
\item[\textbf{[C.3]}] Seongyu Kim*, \textbf{Seoungwoo Lee}*, Hyeonggon Ryu, Joon Son Chung, Arda Senocak. \href{https://arxiv.org/abs/2606.27307}{See \& Sniff: Learning Visuo-Olfactory Representations.} \textit{European Conference on Computer Vision (\textbf{ECCV})}, 2026.
\vspace{0.2mm}

\item[\textbf{[C.2]}] Seongyu Kim, \textbf{Seoungwoo Lee}, Hyeonggon Ryu, Joon Son Chung, Arda Senocak. \href{https://arxiv.org/abs/2604.11579}{Seeing Through Touch: Tactile-Driven Visual Localization of Material Regions.} \textit{IEEE / CVF Conference on Computer Vision and Pattern Recognition (\textbf{CVPR})}, 2026.
\vspace{0.2mm}

\item[\textbf{[C.1]}] Chaeyoung Jung, Youngjoon Jang, \textbf{Seoungwoo Lee}, Joon Son Chung. \href{https://doi.org/10.1109/ICASSP55912.2026.11463130}{FastAV: Efficient Token Pruning for Audio-Visual Large Language Model Inference.} \textit{IEEE International Conference on Acoustics, Speech and Signal Processing (\textbf{ICASSP})}, 2026.
\vspace{0.2mm}
% DOI: 10.1109/ICASSP55912.2026.11463130
...
\vspace{-0.4mm}
  \resumeSubHeadingListStart
  \resumeSubheading
      {Speech Recognition Systems (EE738/EE70038)}{}
      {Teaching Assistant}{Spring 2025-2026}
      \vspace{1mm}
  \resumeSubheading
      {Deep Learning for Visual Understanding (EE488/EE40034)}{}
      {Teaching Assistant}{Fall 2024-2025}
      \vspace{1mm}
  \resumeSubHeadingListEnd
\vspace{-5mm}
